            ...
            >
              ...
              >
                <Box
                  ...
                  onClick={handleRef}
                  p="8px"
                  border={MobileCur === "home" ? "1px solid #e1b75e" : "none"}
                >
                  HOME
                </Box>
                <Box
                  ...
                  onClick={handleRef2}
                  p="8px"
                  border={MobileCur === "about" ? "1px solid #e1b75e" : "none"}
                >
                  ABOUT
                </Box>
                <Box
                  ...
                  onClick={handleRef3}
                  p="8px"
                  border={MobileCur === "skill" ? "1px solid #e1b75e" : "none"}
                >
                  SKILLS
                </Box>
                <Box
                  ...
                  p="8px"
                  border={
                    MobileCur === "project" ? "1px solid #e1b75e" : "none"
                  }
                >
                  PROJECTS
                </Box>
                <Box
                  ...
                  onClick={handleRef5}
                  p="8px"
                  border={MobileCur === "github" ? "1px solid #e1b75e" : "none"}
                >
                  CEO
                </Box>
                <Box
                  ...
                  p="8px"
                  border={
                    MobileCur === "contact" ? "1px solid #e1b75e" : "none"
                  }
                >
                  CONTACT
                </Box>
